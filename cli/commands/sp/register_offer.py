...
from cli.services.contracts.sp_registry import SPRegistryOfferInput, SPRegistryOfferTerms, SPRegistryOfferPaymentInput
...
def register_offer(provider_id: str,
    ...
    commands_utils.register_offers([offer], sp_signer())
